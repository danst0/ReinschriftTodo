...
pub fn t(key: &str) -> String {
    ...
    let translations = TRANSLATIONS.get_or_init(|| {
        ...
        es.insert("local_file", "Archivo local");
        es.insert("location_group", "Lugar: {}");
        es.insert("no_checkbox_error", "La línea no contiene una casilla de verificación");
        ...
        es.insert("rollback_failed", "Error al revertir: {}");
        es.insert("save", "Guardar");
        es.insert("save_task_error", "No se pudo guardar la tarea: {}");
        es.insert("storage", "Almacenamiento");
        es.insert("today", "Hoy");
        es.insert("todo_not_found", "No se pudo encontrar la tarea en el archivo");
        es.insert("topic_group", "Tema: {}");
        es.insert("update_failed", "Error al actualizar: {}");
        es.insert("use_this_method", "Usar este método");
        es.insert("webdav", "WebDAV");
        ...
        sv.insert("general", "Allmänt");
        sv.insert("storage", "Lagring");
        sv.insert("local_file", "Lokal fil");
        sv.insert("webdav", "WebDAV");
        sv.insert("use_this_method", "Använd denna metod");
        ...
        fr.insert("general", "Général");
        fr.insert("storage", "Stockage");
        fr.insert("local_file", "Fichier local");
        fr.insert("webdav", "WebDAV");
        fr.insert("use_this_method", "Utiliser cette méthode");
        ...
        ja.insert("general", "一般");
        ja.insert("storage", "ストレージ");
        ja.insert("local_file", "ローカルファイル");
        ja.insert("webdav", "WebDAV");
        ja.insert("use_this_method", "この方法を使用する");
